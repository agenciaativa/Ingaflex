...
use Ingaflex\Services\LinhaDestaqueServices;
use Ingaflex\Services\ParceirosServices;
use Ingaflex\Services\SlidesServices;

class LinhaDestaqueController extends Controller
{
     ...
     * @param LinhaDestaqueServices $service
     */

    public function __construct(LinhaDestaqueRepository $repository, LinhaDestaqueServices $service)
    {
